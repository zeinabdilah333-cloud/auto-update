...
bot.command("XxX", checkWhatsAppConnection,checkCooldown, async (ctx) => {
...
bot.command("stuck", checkWhatsAppConnection,checkCooldown, async (ctx) => {
...
bot.command("soulB", checkWhatsAppConnection,checkCooldown, async (ctx) => {
...
bot.command("matrix", checkWhatsAppConnection,checkCooldown, async (ctx) => {
